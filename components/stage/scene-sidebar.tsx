    ...
    >
      ...
      {!collapsed && (
        <div
          ...
          className="absolute right-0 top-0 bottom-0 w-1.5 cursor-col-resize z-50 group hover:bg-teal-400/30 dark:hover:bg-teal-600/30 active:bg-teal-500/40 dark:active:bg-teal-500/40 transition-colors"
        >
      ...
      <div className={cn('flex flex-col w-full h-full overflow-hidden', collapsed && 'hidden')}>
        ...
        <div className="h-10 flex items-center justify-between shrink-0 relative mt-3 mb-1 px-3">
          ...
          >
            <img src="/logo-horizontal.png" alt="Open Classroom" className="h-6" />
          </button>
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isActive
                    ? 'bg-teal-50 dark:bg-teal-900/20 ring-1 ring-teal-200 dark:ring-teal-700'
                ...
                <div className="relative aspect-video w-full rounded overflow-hidden bg-gray-100 dark:bg-gray-800 ring-1 ring-black/5 dark:ring-white/5">
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    {isSlide && (
                      <div
                        className={cn(
                          'absolute inset-0 bg-teal-500/0 transition-colors',
                          isActive
                            ? 'bg-teal-500/0'
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isActive &&
                      !isFailed &&
                      'bg-teal-50 dark:bg-teal-900/20 ring-1 ring-teal-200 dark:ring-teal-700 opacity-100',
                  )}
                >
                  {/* Scene Header */}
                  <div className="flex justify-between items-center px-2 pt-0.5">
