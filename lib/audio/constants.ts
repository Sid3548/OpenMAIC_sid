...
export const TTS_PROVIDERS: Record<TTSProviderId, TTSProviderConfig> = {
  ...
  'google-tts': {
    ...
    voices: [
      // Standard voices — $4/M chars, 4M free/month
      {
        id: 'en-US-Standard-C',
        name: 'Emma (English)',
        language: 'en-US',
        ...
        gender: 'female',
        description: 'voiceGoogleEnglishStdC',
      },
      {
        id: 'en-US-Standard-D',
        name: 'James (English)',
        ...
        localeName: 'English (US)',
        gender: 'male',
        description: 'voiceGoogleEnglishStdD',
      },
      {
        id: 'en-US-Standard-A',
        name: 'Alex (English)',
        ...
        localeName: 'English (US)',
        gender: 'male',
        description: 'voiceGoogleEnglishStdA',
      },
      {
        id: 'en-US-Standard-E',
        name: 'Lily (English)',
        ...
        localeName: 'English (US)',
        gender: 'female',
        description: 'voiceGoogleEnglishStdE',
      },
      {
        id: 'hi-IN-Standard-A',
        name: 'Priya (Hindi)',
        ...
        gender: 'female',
        description: 'voiceGoogleHindiStdA',
      },
      {
        id: 'hi-IN-Standard-B',
        name: 'Arjun (Hindi)',
        ...
        localeName: 'हिन्दी (भारत)',
        gender: 'male',
        description: 'voiceGoogleHindiStdB',
      },
      {
        id: 'zh-CN-Standard-A',
        name: 'Mei (Chinese)',
        ...
        localeName: '中文 (中国)',
        gender: 'female',
        description: 'voiceGoogleChineseStdA',
      },
      // Neural2 voices — $16/M chars, premium quality
      {
        id: 'en-US-Neural2-C',
        name: 'Emma HD (English)',
        language: 'en-US',
        localeName: 'English (US)',
        gender: 'female',
